export const carsDescriptions = {
  relacoesPessoais: {
    ...
    levels: {
      ...
      1.5: '',
      2: 'Relações levemente anormais: A criança pode evitar olhar o adulto nos olhos, evitar o adulto ou ter uma reação exagerada se a interação é forçada, ser excessivamente tímido, não responder ao adulto como esperado ou agarrar-se aos pais um pouco mais que a maioria das crianças da mesma idade.',
      2.5: '',
  ...
  respostaMudancas: {
    ...
    levels: {
      ...
      1.5: '',
      2: 'Respostas à mudança levemente anormal: Quando um adulto tenta mudar tarefas, a criança pode continuar na mesma atividade ou usar os mesmos materiais.',
      2.5: '',
      3: 'Respostas à mudança moderadamente anormal: A criança resiste ativamente a mudanças na rotina, tenta continuar sua antiga atividade e é difícil de distraí-la. Ela pode tornar-se infeliz e zangada quando uma rotina estabelecida é alterada.',
      3.5: '',
      4: 'Respostas à mudança gravemente anormal: A criança demonstra reações graves às mudanças. Se uma mudança é forçada, ela pode tornar-se extremamente zangada ou não disposta a ajudar e responder com acessos de raiva.',
    },
  },
  respostaVisual: {
  ...
  respostaAuditiva: {
    ...
    levels: {
      ...
      2.5: '',
      3: 'Respostas auditivas moderadamente anormal: As repostas da criança aos sons variam. Frequentemente ignora o som nas primeiros vezes em que é feito. Pode assustar-se ou cobrir as orelhas ao ouvir alguns sons do cotidiano.',
      3.5: '',
